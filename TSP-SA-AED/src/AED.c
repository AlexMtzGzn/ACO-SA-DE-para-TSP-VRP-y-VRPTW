...
void construyeRuidosos(individuo *objetivo, individuo *ruidoso, int poblacion)
{
    for (int i = 0; i < poblacion; ++i)
    {
        ...
        if (ruidoso[i].temperatura_inicial > 1000.0) ruidoso[i].temperatura_inicial = 1000.0;
        if (ruidoso[i].temperatura_inicial < 900.0) ruidoso[i].temperatura_inicial = 900.0;
        if (ruidoso[i].temperatura_final > 0.25) ruidoso[i].temperatura_final = 0.25;
        if (ruidoso[i].temperatura_final < 0.1) ruidoso[i].temperatura_final = 0.1;
        if (ruidoso[i].enfriamiento > 0.99) ruidoso[i].enfriamiento = 0.99;
        if (ruidoso[i].enfriamiento < 0.9) ruidoso[i].enfriamiento = 0.9;
        if (ruidoso[i].numIteraciones > 20) ruidoso[i].numIteraciones = 20;
        if (ruidoso[i].numIteraciones < 5) ruidoso[i].numIteraciones = 5;
    }
}
