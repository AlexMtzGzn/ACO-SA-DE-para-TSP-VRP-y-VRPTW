...
int main(int argc, char *argv[])
{
    ...
    aed_cvrp(num_poblacion, num_generaciones, tamanio_instancia, archivo_instancia);   // Enviamos al como parametro el numero de la poblacion , numero de generaciones , y el archivo de la instancia
    return 0;
}