...
El objetivo es encontrar un recorrido que minimice la suma de las distancias entre las ciudades, cumpliendo con las restricciones mencionadas anteriormente. Usando programación lineal entera, se puede resolver el problema encontrando los valores óptimos para las variables $X_{ij}$.
