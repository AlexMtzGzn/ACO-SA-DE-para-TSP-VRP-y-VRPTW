...
\begin{figure}[H]
	...
	\end{algorithm}
	\caption{Pseudocódigo de verificación de clientes factibles en Optimización por Colonia de Hormigas.}
...
Los operadores se dividen en dos categorías principales operadores intra-ruta y operadores inter-ruta:
