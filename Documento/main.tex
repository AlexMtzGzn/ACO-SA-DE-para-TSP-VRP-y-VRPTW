...
\subsubsection{Pseudocódigo del Algortimo Recocido Simulado}

El proceso del SA se utiliza como mecanismo de mejora local para refinar las soluciones generadas inicialmente por ACO. Su objetivo es explorar vecindarios diversos mediante un esquema probabilístico que permite aceptar soluciones peores de manera controlada, con el fin de escapar de óptimos locales. El algoritmo completo se presenta en la Figura~\ref{fig:algoritmo_sa_principal}. Este procedimiento incluye la selección de operadores adaptativos, la actualización de temperatura y la gestión explícita de memoria para las estructuras de rutas y flotas.
