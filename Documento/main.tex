...
En la teor\'ia de la complejidad, nos enfocamos principalmente en problemas de decisi\'on, aquellos donde la respuesta es un simple ''sí'' o ''no''. La clase P est\'a compuesta por problemas que pueden ser resueltos en tiempo polinomial. Esto significa que existe un algoritmo que, dado un problema de tama\~no $n$, puede resolverlo en un tiempo que crece a lo sumo como un polinomio de $n$.
...
La clase NP abarca problemas donde una soluci\'on afirmativa ("sí") puede verificarse en tiempo polinomial. En estos problemas, existe un testigo o certificado que sirve como prueba de la validez de la respuesta, y un algoritmo verificador que puede validar este testigo eficientemente.
