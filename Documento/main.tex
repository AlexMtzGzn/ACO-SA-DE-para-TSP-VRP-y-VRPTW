...
\begin{itemize}
	\item \textbf{Mutación:} genera un vector mutante $v_i$ combinando individuos de la población. Una de las estrategias más utilizadas es DE/rand/1:
	      \begin{equation}
...
\begin{figure}[H]
	...
	\end{algorithm}
	\caption{Pseudocódigo del Algoritmo de Evolución Diferencial aplicado al problema VRP-TW.}
...
\begin{figure}[H]
	...
	\end{algorithm}
	\caption{Pseudocódigo para calcular clientes factibles en Optimización por Colonia de Hormigas.}
...
\begin{figure}[H]
	...
	\end{algorithm}
	\caption{Pseudocódigo del cálculo del fitness total de una solución en Optimización por Colonia de Hormigas.}
...
\begin{figure}[H]
	...
	\end{algorithm}
	\caption{Pseudocódigo de la Optimización por Colonia de Hormigas con Recocido Simulado para VRP-TW.}
...
\begin{figure}[H]
	...
	\end{algorithm}
	\caption{Pseudocódigo de verificación completa de restricciones para una ruta.}
...
\begin{figure}[H]
	...
	\end{algorithm}
	\caption{Pseudocódigo del proceso de limpieza de vehículos vacíos de la flota.}
...
\begin{figure}[H]
	...
	\end{algorithm}
	\caption{Pseudocódigo de evaluación de la función objetivo para una solución completa en el Recocido Simulado.}
...
\begin{figure}[H]
	...
	\end{algorithm}
	\caption{Pseudocódigo de Recocido Simulado para refinamiento de soluciones VRP-TW.}
...
% % En esta sección se presentan los resultados obtenidos mediante la implementación del algoritmo de Optimización por Colonia de Hormigas (ACO) aplicado al problema VRPTW sobre las instancias de Solomon. Se analizaron instancias de 25, 50 y 100 clientes, evaluando el desempeño del algoritmo en términos de su mejor solución alcanzada, valor promedio, peor caso y estabilidad medida con varianza y desviación estándar.

% Las pruebas se realizaron ejecutando el algoritmo 15 veces por instancia, manteniendo fijos los parámetros globales (número de hormigas, iteraciones, $\alpha$, $\beta$, $\rho$). Con ello se busca medir robustez, consistencia y sensibilidad del método frente a la aleatoriedad inherente del proceso.

\section{Resultados con 25 clientes}

% En la Tabla \ref{tabla_25} se muestran los resultados obtenidos para las instancias con 25 clientes. Puede observarse que para C101, C103, C201 y C202 el algoritmo logra igualar el valor reportado en la literatura, lo que indica que el ACO presenta buena capacidad de convergencia en problemas de baja escala. 

% La instancia C102 muestra un comportamiento diferente al presentar desviación estándar de 7.04, reflejando variabilidad entre ejecuciones debido a la naturaleza probabilística del método. No obstante, el valor mínimo alcanzado coincide con el reportado, señalando que el algoritmo sí es capaz de llegar al óptimo aunque no siempre de manera consistente.

% \begin{table}[H]
% \centering
% \caption{Resultados con instancias de 25 clientes.}
% \label{tabla_25}
% \begin{tabular}{|c|c|c|c|c|c|c|}
% \hline
% Instancia & Mejor Rep. & Mejor & Peor & Promedio & Varianza & Desviación \\
% \hline
% C101 & 191.3 & 191.3 & 191.3 & 191.30 & 0.00 & 0.00 \\
% C102 & 190.3 & 190.3 & 215.8 & 193.66 & 49.56 & 7.04 \\
% C103 & 190.3 & 190.3 & 192.2 & 190.49 & 0.29 & 0.54 \\
% C201 & 214.7 & 214.7 & 214.7 & 214.7 & 0.00 & 0.00 \\
% C202 & 214.7 & 214.7 & 214.7 & 214.7 & 0.00 & 0.00 \\
% \hline
% \end{tabular}
% \end{table}
...
% En la Tabla \ref{tabla_50} se presentan los resultados correspondientes a las instancias con 50 clientes. Nuevamente se observa un comportamiento estable para C105 y C106, donde todas las ejecuciones alcanzaron el mismo valor. Sin embargo, la instancia C104 presenta variación moderada, lo que sugiere un incremento en la complejidad del espacio de búsqueda a medida que crece el número de clientes.
% \begin{table}[H]
% \centering
% \caption{Resultados con instancias de 50 clientes.}
% \label{tabla_50}
% \begin{tabular}{|c|c|c|c|c|c|c|}
% \hline
% Instancia & Mejor Rep. & Mejor & Peor & Promedio & Varianza & Desviación \\
% \hline
% C104 & 359.0 & 358.0 & 366.1 & 361.11 & 6.17 & 2.48 \\
% C105 & 362.4 & 362.4 & 362.4 & 362.4  & 0.00 & 0.00 \\
% C106 & 362.4 & 362.4 & 362.4 & 362.4  & 0.00 & 0.00 \\
% C203 & 359.8 & -- & -- & -- & -- & -- \\
% C204 & 359.8 & -- & -- & -- & -- & -- \\
% \hline
% \end{tabular}
...
% Los resultados muestran que ACO es especialmente robusto en instancias pequeñas y medianas, logrando soluciones óptimas o muy cercanas al valor teórico. El desempeño se mantiene estable hasta las 50 solicitudes, aunque comienza a mostrarse ligera dispersión conforme crece la complejidad del VRPTW.

% En términos estadísticos, la varianza cercana a cero en la mayoría de las instancias confirma que el algoritmo converge de manera consistente. Sin embargo, instancias como C102 y C104 abren oportunidad para futuras mejoras mediante ajuste de parámetros o inclusión de métodos híbridos como búsqueda local, recocido simulado o evolución diferencial.

% \section{Conclusión del Capítulo}

% A partir de los resultados obtenidos se concluye que ACO es un enfoque eficaz para resolver VRPTW en instancias pequeñas y medianas, logrando gran estabilidad estadística y competitividad con respecto a resultados de referencia. 

% El crecimiento del problema empieza a impactar la variabilidad, lo que sugiere que futuras líneas de trabajo deben considerar hibridación, ajuste dinámico de parámetros y paralelización del proceso de construcción de soluciones, con el fin de mejorar la exploración del espacio de búsqueda en instancias de mayor escala.
