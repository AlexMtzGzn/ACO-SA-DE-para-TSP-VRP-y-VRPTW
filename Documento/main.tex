...
El DE ha demostrado ser altamente competitivo frente a otras metaheurísticas por su balance entre simplicidad y rendimiento, además de requerir pocos parámetros de control \cite{das2011differential}. Aunque originalmente fue diseñado para problemas de optimización continua, el DE ha sido ampliamente empleado en la calibración de parámetros de otros algoritmos de optimización, aprovechando su capacidad para explorar eficientemente espacios de búsqueda de dimensión moderada.
