...
En la Figura~\ref{fig:decidibilidad} se ilustra la clasificación de los problemas desde el punto de vista computacional, dividiéndolos en decidibles e indecidibles.
\begin{figure}[H]
	\centering
...
En el contexto de este trabajo, los problemas abordados —el \textbf{Problema del Agente Viajero (TSP)}, el \textbf{Problema de Ruteo de Vehículos (VRP)} y su variante con restricciones temporales, el \textbf{Problema de Ruteo de Vehículos con Ventanas de Tiempo (VRPTW)}— son considerados \textbf{problemas decidibles}. A continuación, se analizan las clases de complejidad que resultan relevantes para comprender la dificultad computacional asociada a su resolución.
...
En la Figura~\ref{fig:p_vs_np} se muestra la relación entre las clases de complejidad computacional: P, NP, NP-completo y NP-difícil.
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{Figuras/P _vs_NP.pdf}
