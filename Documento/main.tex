...
\titulo{Optimización del TSP, VRP y VRPTW mediante una metaheurística híbrida ACO-SA con calibración de parámetros por Evolución Diferencial}
...
\begin{minipage}[c][9.5cm][s]{10cm}
	\begin{center}
		...
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		% Título del trabajo (ajustar acentos y mayúsculas)
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\vspace{2cm}
		...
		\makebox[10cm]{Departamento de Matemáticas Aplicadas e Ingeniería}\\[13pt]
		\makebox[10cm]{División de Ciencias Naturales e Ingeniería}\\[13pt]
