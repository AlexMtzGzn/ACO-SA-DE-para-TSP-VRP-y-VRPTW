...
//     // Seleccionar segmento a invertir (evitando depósitos)
//     int idx1 = rand() % (total_clientes - 2) + 1; // Entre 1 y total_clientes-2
//     int idx2 = rand() % (total_clientes - 2) + 1; // Entre 1 y total_clientes-2
...
//     // Asegurar que el segmento tenga al menos 2 elementos
//     if (idx2 - idx1 < 1)
//         return false;
...
//     if (nodo_temp != NULL && idx2 >= total_clientes)
//     {
//         free(nodos);
//         liberar_memoria_arreglo_int(clientes_originales);
//         return false;
...
//     int pos_origen = rand() % total_origen; // Posición 0 a total_origen-1

//     // Navegar al cliente origen (saltando depósito inicial)
//     nodo_ruta *nodo_cliente = vehiculo_origen->vehiculo->ruta->cabeza->siguiente;
...
//     // Posición destino: puede ser cualquier posición en la ruta
//     int pos_destino = rand() % (total_destino + 1) + 1; // Posición 1 a total_destino+1
...
//     // Revertir: restaurar en origen (pos_origen + 1 para compensar la indexación)
...
//     // Seleccionar segmento de 1-2 clientes
//     int tamanio_segmento = 1 + (rand() % 2); // 1 o 2 clientes
//     int inicio_segmento = rand() % (total_origen - tamanio_segmento + 1); // Posición 0 a total_origen-tamanio_segmento

//     // Ajustar tamaño si excede límites
//     if (inicio_segmento + tamanio_segmento > total_origen)
//         tamanio_segmento = total_origen - inicio_segmento;
...
//     // Eliminar segmento del origen (en orden inverso)
//     for (int i = tamanio_segmento - 1; i >= 0; i--)
//     {
//         eliminar_cliente_ruta(vehiculo_origen->vehiculo, vrp, clientes_segmento[i], instancia_distancias);
//     }
...
//     // Revertir: restaurar en origen (compensar indexación)
//     for (int i = 0; i < tamanio_segmento; i++)
//     {
//         insertarClienteEnPosicion(vehiculo_origen->vehiculo, vrp,
...
//             return false;
//         }
//     } while ((nueva_posicion >= inicio_segmento + 1 &&
//               nueva_posicion < inicio_segmento + tamanio_segmento + 1) ||
//              (nueva_posicion == inicio_segmento + tamanio_segmento + 1 && tamanio_segmento == total_clientes));
...
//     // Ajustar nueva posición si es necesario
//     if (nueva_posicion > inicio_segmento + 1)
//         nueva_posicion -= tamanio_segmento;
...
//     // Insertar segmentos intercambiados (compensar indexación)
//     bool factible = true;
...
//     {
//         factible = insertarClienteEnPosicion(primer_vehiculo->vehiculo, vrp,
//                                              segmento2[i], inicio1 + i + 1, instancia_distancias);
//     }
...
//     {
//         factible = insertarClienteEnPosicion(segundo_vehiculo->vehiculo, vrp,
//                                              segmento1[i], inicio2 + i + 1, instancia_distancias);
//     }
...
//     // Restaurar segmentos originales (compensar indexación)
//     for (int i = 0; i < tamanio1; i++)
//     {
//         insertarClienteEnPosicion(primer_vehiculo->vehiculo, vrp,
//                                   segmento1[i], inicio1 + i + 1, instancia_distancias);
//     }
//     for (int i = 0; i < tamanio2; i++)
//     {
//         insertarClienteEnPosicion(segundo_vehiculo->vehiculo, vrp,
//                                   segmento2[i], inicio2 + i + 1, instancia_distancias);
//     }
...
//     // CORREGIDO: Lógica de tamaño de cadena mejorada
//     int max_cadena = (total_origen / 2 > 4) ? 4 : total_origen / 2;
//     if (max_cadena < 2)
//         max_cadena = 2;
    
//     // Si es el mismo vehículo, limitar para dejar al menos 1 cliente
//     if (vehiculo_origen == vehiculo_destino && max_cadena >= total_origen)
//         max_cadena = total_origen - 1;
    
//     if (max_cadena < 2)
//         return false; // No es posible realizar la operación

//     // CORREGIDO: Cálculo correcto del tamaño de cadena
//     int tamanio_cadena;
//     if (max_cadena == 2)
//         tamanio_cadena = 2;
//     else
...
//     // CORREGIDO: Selección de posición inicial más segura
...
//     // Reservar memoria para la cadena de clientes
//     int *cadena_clientes = malloc(tamanio_cadena * sizeof(int));
//     if (!cadena_clientes)
//         return false;
    
//     // Array auxiliar para almacenar posiciones originales (para restauración)
...
//     // CORREGIDO: Extraer clientes con verificaciones de seguridad
//     nodo_ruta *nodo_temp = vehiculo_origen->vehiculo->ruta->cabeza->siguiente;
    
//     // Navegar hasta el inicio de la cadena
...
//     // Verificar que se extrajeron todos los clientes necesarios
//     if (nodo_temp == NULL && tamanio_cadena > 0)
//     {
//         // Verificar si el último cliente de la cadena es válido
//         nodo_temp = vehiculo_origen->vehiculo->ruta->cabeza->siguiente;
//         int contador = 1;
//         while (nodo_temp && contador < inicio_cadena + tamanio_cadena - 1)
//         {
//             nodo_temp = nodo_temp->siguiente;
//             contador++;
//         }
...
//     // CORREGIDO: Eliminar cadena en orden correcto (desde la posición más alta)
...
//         // CORREGIDO: Revertir eliminando desde la posición más alta
...
//     else
//     {
//         // Eliminar clientes parcialmente insertados
//         for (int i = clientes_insertados - 1; i >= 0; i--)
//         {
//             eliminar_cliente_ruta(vehiculo_destino->vehiculo, vrp,
//                                   cadena_clientes[i], instancia_distancias);
...
//     // CORREGIDO: Restaurar cadena en vehículo origen en orden correcto
...
//         if (!restaurado)
//         {
//             // Si falla la restauración en la posición exacta, insertar al final
//             insertarClienteEnPosicion(vehiculo_origen->vehiculo, vrp,
//                                       cadena_clientes[i],
